                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-5 font-semibold"><a href="#"
                                    class="underline text-gray-900 dark:text-white">{{ $property->property_name
                                    }}</a><br>
                                ...
                                @foreach($property->locations as $property_location)
                                <div class="mt-1 text-grey-500 dark:text-gray-400 text-sm">
                                    Location: {{ $property_location->location_name }}
                                </div>
                                @endforeach
                            </div>
